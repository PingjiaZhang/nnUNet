...
from nnunet.training.dataloading.dataset_loading_ng import load_dataset, DataLoader3D_ng, DataLoader2D, unpack_dataset
...
class nnUNetTrainer_ng(NetworkTrainer):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
        ...
        """
        super(nnUNetTrainer_ng, self).__init__(deterministic, fp16)
    ...
    def run_training(self):
        ...
        super(nnUNetTrainer_ng, self).run_training()
    ...
    def get_basic_generators(self):
        ...
        if self.threeD:
            dl_tr = DataLoader3D_ng(self.dataset_tr, self.basic_generator_patch_size, self.patch_size, self.batch_size,
                                    False, oversample_foreground_percent=self.oversample_foreground_percent,
                                    pad_mode="constant", pad_sides=self.pad_all_sides, memmap_mode='r')
            dl_val = DataLoader3D_ng(self.dataset_val, self.patch_size, self.patch_size, self.batch_size, False,
